class Site::EstablishmentsController < SiteController
  ...
  def create
    ...
    respond_to do |format|
      if @establishment.save
        format.html { redirect_to [:site,@establishment], notice: 'Establishment was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @establishment.update(establishment_params)
        format.html { redirect_to [:site,@establishment], notice: 'Establishment was successfully updated.' }
