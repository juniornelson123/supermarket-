class Site::ProductsController < SiteController
  ...
  def create
    ...
    respond_to do |format|
      if @product.save
        format.html { redirect_to [:site,@product], notice: 'Product was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @product.update(product_params)
        format.html { redirect_to [:site,@product], notice: 'Product was successfully updated.' }
